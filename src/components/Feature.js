...
export default function Feature({ items }) {
  ...
  return (
    <div className="flex lg:grid grid-cols-12 lg:gap-4 flex-col lg:flex-row rounded-lg bg-transparent lg:bg-tertiary lg:shadow-md mx-auto mt-[2rem] max-w-4xl w-full lg:max-w-7xl px-4 lg:py-4">
