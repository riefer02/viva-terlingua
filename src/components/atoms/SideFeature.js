  ...
  return (
    <Link to={slug} className="relative block group">
      <div className="lg:group-hover:bg-primary-light shadow-md pointer-events-none md:pointer-events-auto flex lg:grid grid-cols-10 justify-between bg-white transition ease-linear flex-col lg:flex-row mb-10 lg:mb-0 min-h-[170px]">
        ...
        <div className="flex flex-col col-span-8 justify-between p-10 lg:flex-row lg:group-hover:text-white relative">
          ...
          <div className="lg:group-hover:translate-x-2 transition ease-liner shadow-sm w-full lg:w-auto px-6 lg:absolute top-[18px] -right-16 inline-block bg-primary-light lg:group-hover:bg-secondary text-white py-3 -skew-x-12 hover:bg-secondary">
