    ...
    <div className="relative mx-auto max-w-7xl overflow-hidden text-center">
      <div className="flex flex-col">
        ...
        <div className=" bottom-0 lg:bottom-4 flex items-center justify-center w-full">
          <div className=" bg-gray-light-1 border-t-2 border-b-2 border-secondary py-4 xl:py-6 xl:rounded-b-lg flex flex-col gap-2 w-full min-h-[70px] lg:min-h-[80px] shadow-lg mx-auto text-gray-dark justify-center items-center">
