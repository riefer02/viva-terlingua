    ...
    <div>
      <Layout>
        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="bg-secondary py-4 mx-auto shadow-md rounded-sm mb-10 md:mb-10 md:-skew-x-12 border-gray-light-1 border-2 max-w-5xl">
          ...
          <div className="block md:hidden text-lg py-4 bg-tertiary">
            Filters Options:
          </div>
          <div className="grid grid-cols-2 p-4 py-8 md:py-3 mx-auto rounded-lg max-w-3xl md:flex flex-col md:flex-row gap-4 items-center justify-center text-base bg-tertiary border-b-2 md:border-0 border-b-tertiary shadow-md">
